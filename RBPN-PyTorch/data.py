...
from dataset import DatasetFromFolderTest, DatasetFromPreprocFolder, DatasetFromFolder
...
def get_preproc_training_set(data_dir, nFrames, upscale_factor, data_augmentation, file_list, other_dataset, patch_size, future_frame):
    return DatasetFromPreprocFolder(data_dir,nFrames, upscale_factor, data_augmentation, file_list, other_dataset, patch_size,future_frame,
                             transform=transform())
