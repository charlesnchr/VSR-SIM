...
class RSTB3D(nn.Module):
    ...
    def __init__(self,
        ...
        self.resi_connection1 = nn.Conv2d(9, 64, 3, 1, 1)
        self.resi_connection2 = ResidualGroup(num_feat=64,squeeze_factor=16,num_block=10)
        self.resi_connection3 = nn.Conv2d(64, 9, 3, 1, 1)
...
class PatchUnEmbed3D(nn.Module):
    def __init__(self, patch_size=(3,4,4), in_chans=3, embed_dim=96, norm_layer=nn.LayerNorm):
        ...
        self.conv = nn.Conv2d(9*unembed_dim, 9, 3, 1, 1)
